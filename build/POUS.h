...
typedef struct {
  ...
  __DECLARE_VAR(BOOL,STOP_PB)
  __DECLARE_VAR(BOOL,PEDESTRIAN_PB)
  __DECLARE_VAR(BOOL,STEP0_ACTION)
  __DECLARE_VAR(BOOL,STEP0_1ACTION)
  __DECLARE_VAR(BOOL,STEP1_ACTION)
  __DECLARE_VAR(BOOL,STEP2_ACTION)
